    ...
    <div class="form-floating mt-1">
                    ...
                    <div class="form-floating mt-1">
                        <input type="password" name="password2" class="form-control rounded-0" id="floatingPassword2" placeholder="renter Password">
                        <label for="floatingPassword">renter password</label>
                    </div>
                    <?=showError('password')?>
                    <?=showError('password2')?>
